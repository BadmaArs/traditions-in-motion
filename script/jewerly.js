...
import { jewerly, jewerlyMobile } from "./transform";
...
let objectPosition = window.innerWidth < 600 ? jewerlyMobile : jewerly;
const modelThree = "../jewerly.glb";
// Scene
...
gltfLoader.load(
  ...
  (xhr) => {
    ...
    // в процессе загрузки
    const totalSized = 21850812; // При каждой новой модели занести количество байтов
