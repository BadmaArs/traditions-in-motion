...
import { costume, costumeMobile } from "./transform";
...
let objectPosition = window.innerWidth < 600 ? costumeMobile : costume;
...
gltfLoader.load(
  ...
  (xhr) => {
    ...
    // в процессе загрузки
    const totalSized = 5242480; // При каждой новой модели занести количество байтов
